...
class CoursesStream(UdemyForBusinessStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property(
            "title", th.StringType
        ),  # Course Title, this is the title of the course
        th.Property(
            "description", th.StringType
        ),  # Course Description, this is the description of the course
        th.Property(
            "url", th.StringType
        ),  # This is a URL pointing to the course's web location
        th.Property(
            "estimated_content_length", th.IntegerType
        ),  # Estimated Content Length, this is an estimated length of time the content would take to be consumed
        th.Property(
            "num_lectures", th.IntegerType
        ),  # Number of Lectures, the number of lectures this course comprises of
        th.Property(
            "num_videos", th.IntegerType
        ),  # Number of Videos, the number of videos contained in this course
        th.Property(
            "mobile_native_deeplink", th.StringType
        ),  # Mobile Native Deeplink. This URL will open the course in the Udemy for Business native app for Android or iOS, if installed
        th.Property("is_practice_test_course", th.BooleanType),
        th.Property(
            "num_quizzes", th.IntegerType
        ),  # Number of quizzes contained in the course
        th.Property(
            "num_practice_tests", th.IntegerType
        ...
        th.Property(
            "categories", th.ArrayType(th.StringType)
        ),  # Category, this is a list of categories into which this course fits
        th.Property(
            "instructors", th.ArrayType(th.StringType)
        ),  # Instructor Names, a list of the instructor names for the course
        th.Property(
            "requirements",
            th.ObjectType(th.Property("list", th.ArrayType(th.StringType))),
        ),  # Requirements, a description of requirements for this course
        th.Property(
            "images", th.ObjectType(th.Property("size_100x100", th.StringType))
...
class UserProgressStream(UdemyForBusinessStream):
    ...
    def get_url_params(self, partition, next_page_token) -> Dict:
        ...
        params = {"page_size": self._page_size, "from_date": start_date}
        if next_page_token:
            params["page"] = next_page_token
